                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="card card-hover">
                                            <div class="box bg-success text-center">
                                                <h1 class="font-light text-white"><i
                                                        class="mdi mdi-chart-areaspline"></i></h1>
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-3">
                                        <div class="card card-hover">
                                            <div class="box bg-success text-center">
                                                <h1 class="font-light text-white"><i class="mdi mdi-calendar-check"></i>
                                                </h1>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body border-top">
                                ...
                                <div class="progress mt-3">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-cyan"
                                        style="width:70%"></div>
                                </div>
                                <div class="mt-3">
                                    <code>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-warning margin-5 text-white" data-toggle="modal"
                                    data-target="#Modal2">
                                    Alert
                                </button>
                                <!-- Button trigger modal -->
